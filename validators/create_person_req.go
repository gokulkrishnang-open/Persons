...
// func ValidateAllPersonRequest(ctx *gin.Context) error {
...
func ValidateCreatePersonRequest(ctx *gin.Context) (model.PersonResponse, error) {
	person := model.PersonResponse{}
	ctx.BindJSON(&person)
...
func ValidateUpdatePersonRequest(ctx *gin.Context) (model.PersonResponse, error) {
	person := model.PersonResponse{}
	ctx.BindJSON(&person)
	fmt.Println(person)
